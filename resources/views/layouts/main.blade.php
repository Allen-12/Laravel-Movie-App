        ...
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6">
            ...
            <div class="flex flex-col md:flex-row items-center">
                <div class="relative mt-3 md:mt-0">
                    <input type="text" name="" class="bg-gray-800 text-sm rounded-full px-4 pl-8 py-1 focus:outline-none focus:shadow-outline" placeholder="Search">
                ...
                <div class="md:ml-4 mt-3 md:mt-0">
                    <a href="">
                        <img src="{{ asset("images/60111.jpg") }}" alt="avatar" class="rounded-full w-8 h-8">
                    </a>
                </div>
            </div>
        </div>
