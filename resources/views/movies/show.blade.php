...
@section('content')
    ...
    <div class="movie-info border-b border-gray-800 ">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <img src="{{ 'https://image.tmdb.org/t/p/w342'. $movie['poster_path'] }}" alt="22" class="w-64 md:w-96">
            <div class="md:ml-24">
                ...
                <div class="mt-12">
                    <h4 class="text-white font-semibold">Featured Cast & Crew</h4>
                    <div class="flex mt-4">
                ...
                @if(count($movie['videos']['results']) > 0)
                    <div class="mt-12">
                        <a href="https://www.youtube.com/watch?v={{ $movie['videos']['results'][0]['key'] }}" target="_blank" type="submit" class="flex inline-flex items-center bg-yellow-500 text-gray-900 rounded font-semibold
            ...
            <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
                @foreach($movie['images']['backdrops'] as $image)
                    @if($loop->index < 8)
                        <div class="mt-8">
                            <a href="">
                                <img src="{{ 'https://image.tmdb.org/t/p/w342'. $image['file_path'] }}" alt="parasite" class="hover:opacity-75 transition ease-in-out duration-150">
                            </a>
                        </div>
                    @endif
                @endforeach
